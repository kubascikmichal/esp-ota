...
/* ota_file.bin */
extern const uint8_t ota_file_start[] asm("_binary_ota_file_zigbee_bin_start");                    /* ota_file corresponds to filename and bin corresponds to filetype */
extern const uint8_t ota_file_end[]   asm("_binary_ota_file_zigbee_bin_end");                      /* ota_file corresponds to filename and bin corresponds to filetype */
